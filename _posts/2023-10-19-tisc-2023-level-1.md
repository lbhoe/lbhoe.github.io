...
```bash
$ ldd f1315992.elf 
        linux-vdso.so.1 (0x00007ffff8cd8000)
        libc.musl-x86_64.so.1 => not found
```

Found `libc.musl-x86_64.so.1` in `challenge.img` and exported it.

![image](../assets/img/tisc_2023/level_1/c03d66b9a8e1ac1313db1c3cefc3cb91ca9039e8e26199a5464ce77c25d073ef.png)  

Moved `libc.musl-x86_64.so.1` to `/lib` of my VM and ran `f1315992.elf` again.

```bash
$ sudo mv libc.musl-x86_64.so.1 /lib
$ ./f1315992.elf
